...
def pool_tcga_oof():
    # Standardised (2026-07-03) to source the pooled out-of-fold TCGA predictions
    # from the stage-5 M0 harness (fold_results[*].tcga_val_log_h_gnn), the SAME
    # source used by the published Figure 1 (regenerate_figures.py). Previously
    # this read stage_3b_sage_clinical_lasso_honest.json (best_val_log_h), a
    # different M0 run; both figures now use one consistent OOF prediction vector.
