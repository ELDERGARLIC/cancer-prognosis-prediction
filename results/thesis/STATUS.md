...
- **Methods §7** ends with: *"All scripts, configurations, and saved predictions
  are available at [repository URL placeholder]"*. The same placeholder appears
  near the end of the repository `README.md`. Replace both once the public
